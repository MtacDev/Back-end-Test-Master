...
STATICFILES_DIRS = [
    ...
    os.path.join(BASE_DIR,'menu','template', 'resources'),
]
...
#Enabling django message stoge 
MESSAGE_STORAGE = 'django.contrib.messages.storage.cookie.CookieStorage' 

#Allow Celery to use Redis as the broker and backend
